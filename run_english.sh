...
model_dir=models/english/am
ivector_dir=models/english/extractor
conf_dir=models/english/conf
g2p_dir=models/english/g2p/g2p.fst
dict_dir_=models/english/dict
...
if [ $stage -le 1 ]; then
	...
	then
		...
		python check_base_lexicon.py english $tmp_dir/dict/vocab.txt.uniq $tmp_dir/dict/lexicon_valid.txt $tmp_dir/dict/missing_base.txt || exit 0;
