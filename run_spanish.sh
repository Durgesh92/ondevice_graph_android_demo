...
model_dir=models/spanish/am
ivector_dir=models/spanish/extractor
conf_dir=models/spanish/conf
g2p_dir=models/spanish/g2p/g2p.fst
dict_dir_=models/spanish/dict
...
if [ $stage -le 1 ]; then
	...
	then
		...
		phonetisaurus-apply --model ${g2p_dir} --word_list $tmp_dir/dict/vocab.txt.uniq > $tmp_dir/dict/lexicon.txt || exit 0;
