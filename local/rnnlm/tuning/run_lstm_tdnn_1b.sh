...
dir=tmp_danzoo/rnnlm_lstm_tdnn_1b
embedding_dim=800
lstm_rpd=200
lstm_nrpd=200
...
ac_model_dir=tmp_danzoo/chain/tdnn_lstm1b_sp
ngram_order=4
...
text=corpus/corpus_public.txt.gz
wordlist=tmp_danzoo/out/lang/words.txt
text_dir=tmp_danzoo/text_nosp
mkdir -p $dir/config
set -e
...
EOF
  ...
  rnnlm/get_unigram_probs.py --vocab-file=$dir/config/words.txt \
                             ...
                             $text_dir | awk 'NF==2' >$dir/config/unigram_probs.txt || exit 0;
  ...
  rnnlm/choose_features.py --unigram-probs=$dir/config/unigram_probs.txt \
                           ...
                           $dir/config/words.txt > $dir/config/features.txt || exit 0;
...
if [ $stage -le 4 ]; then
  for decode_set in dev93 eval92; do
    ...
    rnnlm/lmrescore_pruned.sh \
      ...
      tmp_danzoo/data/lang_test_$LM $dir \
      tmp_danzoo/data/test_${decode_set}_hires ${decode_dir} \
